Summary: TrustedUploader for the Application Services Gateway
Name: TrustedUploader
Version: 1.0.0
Release: 0001
BuildArch: noarch
...
%description
iControl LX extension to upload files from the API Services Gateway to trusted TMOS devices
